	...
	Public Class GameBoard
		...
		Public Sub CheckSquareAndRecordOutcome(col As Integer, row As Integer)
			For Each ship As Ship In Ships
				...
				End If
			Next
            Squares(col, row) = SquareValues.Miss
			...
			Else
				If orientation = Orientations.Vertical Then
                    For scan As Integer = 0 To ship.Size - 1
                        If Squares(col, row + scan) <> SquareValues.Empty Then
                            Return False
                        End If
                    Next
				ElseIf orientation = Orientations.Horizontal Then
					For Scan As Integer = 0 To ship.Size - 1
                        If Squares(col + Scan, row) <> SquareValues.Empty Then
                            Return False
                        End If
                    Next
				End If
        ...
        Public Function ReadSquare(col As Integer, row As Integer) As SquareValues
