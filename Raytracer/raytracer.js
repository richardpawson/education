...
var Colour = (function () {
    ...
    Colour.prototype.scaleBy = function (k) { return new Colour(k * this.r, k * this.g, k * this.b); };
    Colour.prototype.plus = function (v2) { return new Colour(this.r + v2.r, this.g + v2.g, this.b + v2.b); };
    Colour.prototype.times = function (v2) { return new Colour(this.r * v2.r, this.g * v2.g, this.b * v2.b); };
    Colour.prototype.toDrawingColor = function () {
        var legalize = function (d) { return d > 1 ? 1 : d; };
        return new Colour(Math.floor(legalize(this.r) * 255), Math.floor(legalize(this.g) * 255), Math.floor(legalize(this.b) * 255));
    };
