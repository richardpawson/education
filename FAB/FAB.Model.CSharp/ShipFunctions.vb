...
Namespace FAB
	Public NotInheritable Class ShipFunctions
		Private Sub New()
		End Sub
		<System.Runtime.CompilerServices.Extension> _
		Public Shared Function setPosition(ship As Ship, loc As Location, orient As Orientations) As Ship
			Return New Ship(ship.Name, ship.Size, ship.Hits, loc, orient)
		End Function

		'Calculated based on the size and the orientation of the ship
		<System.Runtime.CompilerServices.Extension> _
		Public Shared Function occupies(ship As Ship, loc As Location) As Boolean
		...
		<System.Runtime.CompilerServices.Extension> _
		Public Shared Function isHitInLocation(ship As Ship, loc As Location) As Boolean
			Return ship.Hits.Contains(loc)
		End Function

		<System.Runtime.CompilerServices.Extension> _
		Public Shared Function fireAt(ship As Ship, loc As Location) As Tuple(Of Ship, Boolean, [String])
			If ship.occupies(loc) Then
				...
				Dim message = If(isSunk(newShip), newShip.Name + " sunk!", "Hit a " + newShip.Name + " at (" + loc.Col + "," + loc.Row + ").")
		...
		<System.Runtime.CompilerServices.Extension> _
		Public Shared Function isSunk(ship As Ship) As Boolean
